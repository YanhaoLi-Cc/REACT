...
total_wait=120  # 2 hours = 120 minutes
interval=30     # Display message every 30 minutes

# Loop to display waiting time
for (( i=total_wait; i>0; i=i-interval )); do
    echo "Waiting for $i minutes before starting the script..."
...
# output path
OUTPUT_DIR="checkpoints/sft/llava-moleculestm-$MODEL_VERSION-sft-notrans"
